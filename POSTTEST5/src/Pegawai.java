...
public final class Pegawai extends User{
    private final ArrayList<Transaksi> transaksiList;

    public Pegawai(String username, String password, String nama, String email, String telepon) {
        super("pegawai", username);
    ...
    public final void inputTransaksi(ArrayList<User> users, ArrayList<PaketLayanan> paketLayanan, Scanner scanner) {
        if (paketLayanan.isEmpty()) {
            System.out.println("Belum ada paket layanan terdaftar.");
            return;
        }
    ...
    public void editProfil(Scanner scanner) {
        System.out.println("\n=== Edit Profil Pegawai ===");
        System.out.print("Email baru [" + email + "]: ");
        String newEmail = scanner.nextLine();
        if (!newEmail.isEmpty())
            setEmail(newEmail);

        System.out.print("Telepon baru [" + telepon + "]: ");
