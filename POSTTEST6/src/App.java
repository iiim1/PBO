...
public class App {
    ...
    private static void initializeData() {
        ...
        paketLayanan.add(new PaketLayanan("Regular", 7000));
        paketLayanan.add(new PaketLayanan("Express", 10000));
        paketLayanan.add(new PaketLayanan("Super Express", 15000));
    }
    ...
    private static void login() {
        try {
            ...
            loginAttempts++;
            System.out.println("Invalid username or password! Attempts left: " + (MAX_LOGIN_ATTEMPTS - loginAttempts));
        ...
        while (running) {
            ...
            switch (pilihan) {
                ...
                case 4:
                    ...
                    try {
                        admin.editProfile(newEmail, newPhone, newPassword);
                    } catch (IllegalArgumentException e) {
                        System.out.println("Gagal mengupdate profil: " + e.getMessage());
                    }
                    break;
                case 5:
                    userLogin = null;
        ...
        while (running) {
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    // Memanggil versi overloading yang menggunakan parameter detail
                    admin.tambahPaketLayanan(paketLayanan, nama, "", harga);
                    break;
                case 3:
        ...
        while (running) {
            ...
            switch (pilihan) {
                ...
                case 5:
                    ...
                    String newPassword = scanner.nextLine();
                    try {
                        pegawai.editProfile(newEmail, newPhone, newPassword);
                    } catch (IllegalArgumentException e) {
                        System.out.println("Gagal mengupdate profil: " + e.getMessage());
                    }
                    break;
        ...
        while (running) {
            ...
            switch (pilihan) {
                ...
                case 4:
                    ...
                    String newPassword = scanner.nextLine();
                    try {
                        pelanggan.editProfile(newEmail, newPhone, newPassword);
                    } catch (IllegalArgumentException e) {
                        System.out.println("Gagal mengupdate profil: " + e.getMessage());
                    }
                    break;
